...
import com.lun.algorithms4th.c2.sorting.IndexMinPQ;
...
public class DijkstraSP {
    ...
    public DijkstraSP(EdgeWeightedDigraph G, int s) {
        ...
        pq = new IndexMinPQ<Double>(G.getNumOfVertex());
    ...
    public static void main(String[] args) {
    	...
    	args = new String[] {"./src/main/resources/tinyEWD.txt","0"}; 
        ...
        // print shortest path
        for (int t = 0; t < G.getNumOfVertex(); t++) {
            if (sp.hasPathTo(t)) {
