...
import com.lun.algorithms4th.c1.fundamental.Queue;
import com.lun.algorithms4th.c1.fundamental.Stack;
import com.lun.algorithms4th.c4.graph.DirectedEdge;
import com.lun.algorithms4th.c4.graph.EdgeWeightedDigraph;
import com.lun.algorithms4th.c4.graph.EdgeWeightedDirectedCycle;
...
public class BellmanFordSP {
    ...
    public BellmanFordSP(EdgeWeightedDigraph G, int s) {
        distTo  = new double[G.getNumOfVertex()];
        edgeTo  = new DirectedEdge[G.getNumOfVertex()];
        onQueue = new boolean[G.getNumOfVertex()];
    ...
    private boolean check(EdgeWeightedDigraph G, int s) {
        ...
        // no negative cycle reachable from source
            ...
            for (int w = 0; w < G.getNumOfVertex(); w++) {
...
//    	args = new String[] {"./src/main/resources/tinyEWDn.txt","0"};
    	args = new String[] {"./src/main/resources/tinyEWDnc.txt","0"};
