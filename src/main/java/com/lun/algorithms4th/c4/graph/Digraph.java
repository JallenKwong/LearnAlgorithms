...
public class Digraph {
    ...
    private final int numOfVertex;           // number of vertices in this digraph
    private int numOfEdge;                 // number of edges in this digraph
    ...
    public Digraph(In in) {
        try {
            ...
            if (numOfVertex < 0) throw new IllegalArgumentException("number of vertices in a Digraph must be nonnegative");
            indegree = new int[numOfVertex];
            adj = (Bag<Integer>[]) new Bag[numOfVertex];
    ...
    public Digraph reverse() {
        Digraph reverse = new Digraph(numOfVertex);
        for (int v = 0; v < numOfVertex; v++) {
            for (int w : adj(v)) {
                reverse.addEdge(w, v);
            }
    ...
    public static void main(String[] args) {
    	...
    	In in = new In(new File("./src/main/resources/tinyDG.txt"));
