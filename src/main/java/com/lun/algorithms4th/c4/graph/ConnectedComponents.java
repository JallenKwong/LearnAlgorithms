 ...
 *  Dependencies: Graph.java System.out.java Queue.java
...
public class ConnectedComponents {
    ...
    private int[] id;           // 用于哪个顶点用于哪个连通量 id[v] = id of connected component containing v
    ...
    public static void main(String[] args) {
        ...
        int numberOfConnectedComponents = cc.count();
        System.out.println(numberOfConnectedComponents + " components");
