 ...
 *  Dependencies: BinaryStdIn.java System.out.java
 ...
 *  <p>
 *  See also {@link BinaryDumpTest} and {@link PictureDump}.
...
public class HexDump {
    ...
    /**
     *change default input stream to file input stream
     * 
     * @param bitsPerLine
     * @param filePath
     */
    public static void print(int bitsPerLine, String filePath) {
    	try {
			BinaryStdIn.changeInputStream(new File(filePath));
		} catch (FileNotFoundException e) {
			e.printStackTrace();
		}
    	
    	main(new String[] {String.valueOf(bitsPerLine)});
