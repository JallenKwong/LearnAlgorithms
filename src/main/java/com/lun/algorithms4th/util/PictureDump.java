 ...
 *  <p>
 *  See also {@link BinaryDumpTest} and {@link HexDump}.
 *
...
public class PictureDump {
     ...
     * @param filePath
     */
    public static void draw(int width, int height, String filePath) {
        try {
		...
		PictureDump.main(new String[] {String.valueOf(width), String.valueOf(height)});
    }
